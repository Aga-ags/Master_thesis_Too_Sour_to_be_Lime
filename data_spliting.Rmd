...
x_tain_only_h2o_ca2cl<- train|>
  filter( pH_origin != "site")|>
  dplyr::select(!c("pH", "pH_origin", "x", "y",   "sample_weight", "lime", "lime_imputed", "lime_imputed_0_2", "lime_imputed_3_5"))|>
  as.matrix()
y_tain_only_h2o_ca2cl<- train|>
  filter(pH_origin != "site")|>
  dplyr::select("pH", "lime")

x_tain_only_ca2cl<- train|>
  filter( pH_origin != "site" & pH_origin != "H2O")|>
  dplyr::select(!c("pH", "pH_origin", "x", "y",   "sample_weight", "lime", "lime_imputed", "lime_imputed_0_2", "lime_imputed_3_5"))|>
  as.matrix()
y_tain_only_ca2cl<- train|>
  filter(pH_origin != "site" & pH_origin != "H2O")|>
  dplyr::select("pH", "lime")
```
...
write.csv(x_tain_only_h2o_ca2cl,file='../data/x_train_only_h2o_ca2cl_all_lime.csv', row.names=FALSE)
write.csv(y_tain_only_h2o_ca2cl,file='../data/y_train_only_h2o_ca2cl_all_lime.csv', row.names=FALSE)

write.csv(x_tain_only_ca2cl,file='../data/x_train_only_ca2cl_all_lime.csv', row.names=FALSE)
write.csv(y_tain_only_ca2cl,file='../data/y_train_only_ca2cl_all_lime.csv', row.names=FALSE)
...
sample_wight_only_h2o_ca2cl_all_lime<- train|>
  filter( pH_origin != "site")|>
  dplyr::select("sample_weight")

write.csv(sample_wight_only_h2o_ca2cl_all_lime,file='../data/sample_weights_only_h2o_ca2cl_all_lime.csv', row.names=FALSE)

sample_wight_only_ca2cl_all_lime<- train|>
  filter(pH_origin != "site" & pH_origin != "H2O")|>
  dplyr::select("sample_weight")

write.csv(sample_wight_only_ca2cl_all_lime,file='../data/sample_weights_only_ca2cl_all_lime.csv', row.names=FALSE)
```
