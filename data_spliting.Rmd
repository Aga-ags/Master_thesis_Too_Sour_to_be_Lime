...
weights_no_site <- prepare_weights(train, pH_origin != "site" & pH_origin != "H2O", file_name = "no_site")
...
x_train_no_lime_imputation_from_3_5_classes <- prepare_x(train, lime_imputed_3_5 == FALSE, file_name = "no_lime_imputation_from_lime_classes")
y_train_no_lime_imputation_from_3_5_classes  <- prepare_y(train, lime_imputed_3_5 == FALSE, file_name = "no_lime_imputation_from_lime_classes")
weights_no_lime_imputation_from_3_5_classes  <- prepare_weights(train, lime_imputed_3_5 == FALSE, file_name = "no_lime_imputation_from_lime_classes")
