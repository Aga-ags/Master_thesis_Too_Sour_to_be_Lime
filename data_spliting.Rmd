...
```{r}
x_train <- train|>
  dplyr::select(!c("pH", "pH_origin", "x", "y", "id_row", "sample_weight", "lime", "lime_imputed", "lime_imputed_0_2", "lime_imputed_3_5"))|>
  as.matrix()
y_train <- train|>
...
write.csv(x_tain_only_H20,file='../data/x_tain_only_H20.csv', row.names=FALSE)
write.csv(y_tain_only_H20,file='../data/y_tain_only_H20.csv', row.names=FALSE)


write.csv(x_tain_pH_imp,file='../data/x_tain_pH_imp.csv', row.names=FALSE)
write.csv(y_tain_pH_imp,file='../data/y_tain_pH_imp.csv', row.names=FALSE)


write.csv(x_tain_H20_and_lime_65,file='../data/x_tain_H20_and_lime_65.csv', row.names=FALSE)
write.csv(y_tain_H20_and_lime_65,file='../data/y_tain_H20_and_lime_65.csv', row.names=FALSE)


write.csv(x_tain_pH_imp_and_lime_65,file='../data/x_tain_pH_imp_and_lime_65.csv', row.names=FALSE)
write.csv(y_tain_pH_imp_and_lime_65,file='../data/y_tain_pH_imp_and_lime_65.csv', row.names=FALSE)


write.csv(x_tain_pH_imp_and_lime_65_0_2,file='../data/x_tain_pH_imp_and_lime_65_0_2.csv', row.names=FALSE)
write.csv(y_tain_pH_imp_and_lime_65_0_2,file='../data/y_tain_pH_imp_and_lime_65_0_2.csv', row.names=FALSE)
