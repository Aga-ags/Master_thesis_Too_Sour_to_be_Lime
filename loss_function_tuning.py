...
results_validation, results_test = train.perform_moodel_training_with_tuning(imputation_scenario = "no_lime_imputation_from_3_5_classes", 
                                    model_name = "lime_no_3_5_classes_zero_mse",
                                    list_of_outputs = ["lime"],
                                    loss_function = {'lime': train.zero_inflated_mse_loss},
                                    results_validation=results_validation,
                                    results_test=results_test,
                                    include_weigths = True)

results_validation, results_test = train.perform_moodel_training_with_tuning(imputation_scenario = "no_lime_imputation_from_3_5_classes", 
                                    model_name = "both_no_3_5_classes_zero_mse",
...
results_validation.to_csv('./tuning_results/zero_mse_parameter_tuning.csv', index=False)
