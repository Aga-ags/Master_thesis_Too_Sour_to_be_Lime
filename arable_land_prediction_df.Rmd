...
```{r}
# save the current data, since next step can fail 
 write.csv(df_depth_10_scaled, file = '../data/prepared_data/map_data_depth_10_no_one_hot.csv', row.names=FALSE)
 write.csv(df_depth_60_scaled, file = '../data/prepared_data/map_data_depth_60_no_one_hot.csv', row.names=FALSE)
```

```{r}
df_depth_10_scaled <- read.csv(file='../data/prepared_data/map_data_depth_10_no_one_hot.csv') 
df_depth_60_scaled <- read.csv(file='../data/prepared_data/map_data_depth_60_no_one_hot.csv') 
```
